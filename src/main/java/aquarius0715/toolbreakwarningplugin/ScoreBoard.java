...
public class ScoreBoard {
    ...
    public void createScoreBoard(Player player) {
        ...
        plugin.nextRank.setSuffix(plugin.remainRank.get(player.getUniqueId()) + "" + ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD);
        ...
        plugin.achieveInt.setSuffix(plugin.remainRank.get(player.getUniqueId()) + "" + ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD);

        plugin.blocks = plugin.scoreboard.registerNewTeam("blocks");
        plugin.blocks.addEntry(ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "総採掘数 : ");
        plugin.blocks.setSuffix(ChatColor.YELLOW + "" + ChatColor.BOLD + plugin.allBlocks.get(player.getUniqueId()) + "" + ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD);

        plugin.noticeStats = plugin.scoreboard.registerNewTeam("noticeStats");
        plugin.noticeStats.addEntry(ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "破壊警告 : ");
        ...
        plugin.objective.getScore(ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "破壊警告 : ").setScore(9);
    ...
    public void updateRank(Player player) {
        ...
        plugin.ranks.setSuffix(plugin.rank.get(player.getUniqueId()));
        plugin.nextRank.setSuffix(String.valueOf(plugin.remainRank.get(player.getUniqueId())));
        player.setScoreboard(plugin.scoreboard);
    }
